...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>GGMS | Forget Password</title>
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span>GGMS | Recover Password</span>
                                </a>
                            </h3>
                            ...
                            <form class="" action="#" name="login" method="post">
                                ...
                                <div class="form-group m-b-20 row">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="email" id="admin_email" name="admin_email" required="" placeholder="Registered Email">
                                    </div>
                                </div>
