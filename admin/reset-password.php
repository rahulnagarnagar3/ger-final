...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>GGMS | Reset Password</title>
...
return true;
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('assets/images/bg-5.jpg');background-size: cover;background-position: center;"></div>
